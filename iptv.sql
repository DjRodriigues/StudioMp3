...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 15-Nov-2020 às 01:27
...
INSERT INTO `usuario` (`id_usuario`, `nome_usuario`, `senha_usuario`, `login_usuario`, `admin`, `vendedor`, `estado_usuario`, `acesso`, `id_criador`, `dia`, `uso`, `uso_dia`) VALUES
(1, 'Administrador do Servidor', '29b2dcbc3c811bc5693c13df2764ea42', 'admin', 1, 0, 1, '', 1, 0, 0, 0);
COMMIT;
